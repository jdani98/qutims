...
#### DATA PREPARATION  ##################################################################
fname = '../data_vdp_mu_2_del_15_ab_100_1000p.dat' # INPUT
data = np.loadtxt(fname)

# QRNN size and layers
nE = 2; nM = 2; nL = 4; nx = 1

x_data = np.array([[data[i,1],data[i,1]] for i in range(len(data[:,1]))]) # 2D-array! Include data encoding in 2 qubits
