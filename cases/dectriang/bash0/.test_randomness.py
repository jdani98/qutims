...
x_data = np.array([[data[i,1]] for i in range(len(data[:,1]))]) # 2D-array! Include data encoding in 2 qubits
...
checkpoints = [4,499,999,1499,1999]
...
for it in range(epochs):
    ...
    if shuffle:
        ...
        with open('indices.csv', 'a') as file:
